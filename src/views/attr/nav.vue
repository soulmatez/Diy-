					...
					<div class="item">
						...
						<div class="input">
							<div class="input-line">
								<span class="sp1">
									<input class="radio" :name="attr.base.c" :checked="attr.base.c == 4" @click="attr.base.c = 4" value="4" type="radio" />
									4列
								</span>
								<span class="sp1">
									<input class="radio" :name="attr.base.c" :checked="attr.base.c == 5" @click="attr.base.c = 5" value="5" type="radio" />
									5列
								</span>
							</div>
						</div>
...
import AttrIcon from '@/views/attr/icon.vue';
